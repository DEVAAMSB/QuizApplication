...
function showResult(){
    ...
    if (userScore > 3){ // if user scored more than 3
        ...
        scoreText.innerHTML = '<span>and congrats! 🎉, You got <p>' + userScore + '</p> out of <p>' + questions.length + '</p></span>';  //adding new span tag inside score_Text
    }
    else if(userScore > 1){ // if user scored more than 1
        scoreText.innerHTML = '<span>and nice 😎, You got <p>' + userScore + '</p> out of <p>' + questions.length + '</p></span>';
    }
    else{ // if user scored less than 1
        scoreText.innerHTML = '<span>and sorry 😐, You got only <p>' + userScore + '</p> out of <p>' + questions.length + '</p></span>';
    }
}
